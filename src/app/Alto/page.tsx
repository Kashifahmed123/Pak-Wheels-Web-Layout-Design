    ...
    return (
        <div className="flex flex-col justify-center items-center space-y-16 my-4 ">
            <div className=" w-full h-auto flex flex-row justify-center float-left"> 
                <h1 className=" font-serif font-bold text-4xl text-gray-700 text-center"> Suzuki Alto 2024 Price in Pakistan, Images, Reviews & Specs</h1> </div>
            <div className="w-96 h-auto float-left justify-center items-center"> 
                <Image src="/alto.jpg" alt="Suzuki Alto" width={250} height={250}/> </div>
            ...
            <div className="flext flex-row justify-center items-center font-serif text-green-500 text-2xl font-semibold">PKR 25,00,000</div>
